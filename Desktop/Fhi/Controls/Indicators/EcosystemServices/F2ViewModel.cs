...
{
    public class F2ViewModel : SpatialUnitViewModel
    {
        ...
        public F2SpatialUnit Su => SpatialUnit as F2SpatialUnit;
        ...
        private void AddYear()
        {
            ...
            foreach (var month in Enumerable.Range(1, 12))
                Su.Results.Add(new ObjectiveResult { Time = new DateTime(SelectedYear, month, 1) });
        }
